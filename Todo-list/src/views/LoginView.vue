<template>
  <div class="container mt-5">
    <h1 class="mb-4 fw-bold text-center text-black">Вход</h1>
    ...
    <p class="mt-4 text-black">Нет акаунта? <router-link to="/register"><span class="fw-bold">Зарегестрируйтесь</span></router-link></p>
  </div>
</template>
